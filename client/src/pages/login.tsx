        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <Button 
              ...
              className="w-full h-12 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm opacity-50 cursor-not-allowed"
              variant="outline"
              disabled
              title="Google OAuth temporarily unavailable - use email authentication below"
            >
